 ...
 Date Of Birth <span class="form-required" title="This field is required.">*</span></label>
            ...
            <div class="form-group col-sm-6">
	            ...
	            <div class="col-sm-4 form_box2">
	                   <div class="select-block1">
	                    <select name="caste">
		                    <option value="No cast">No cast</option>
		                    <option value="Kaishopo Gotro">Kaishopo Gotro</option>
		                    <option value="Alimonno Gotro">Alimonno Gotro</option>
	                    </select>
	                  </div>
	                 </div>
	                 <div class="col-sm-4 form_box1">
	                 ...
	                 <div class="col-sm-4 form_box1">
	                   <div class="select-block1">
	                    <select name="district">
		                    ...
		                    <option value="Narsindi">Narsindi</option>
			    ...
			    <div class="select-block1">
	                <select name="education">
	                    ...
	                    <option value="JSC">JSC</option> 
	               		...
	               		<option value="MSc (Engr.)">MSc (Engr.)</option> 
	               		<option value="MA/MSc/Mcom/MSS">MA/MSc/Mcom/MSS</option> 
		      ...
		      <label for="edit-name">Mother Tounge<span class="form-required" title="This field is required.">*</span></label>
			    <div class="select-block1">
	                <select name="mothertounge">
	                    ...
	                    <option value="Hindi">Arabi</option> 
