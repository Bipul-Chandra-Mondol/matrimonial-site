...
<div class="grid_3">
  <div class="container">
   ...
   <div class="grid_5">
      <p>If you have any quires please contact with us in the given mail or phone number</p>
      <address class="addr row">
        <dl class="grid_4">
            <dt>Address :</dt>
            <dd>
                Komlapur,Faridpur <br>
                Dhaka ,Bangladesh
            </dd>
        </dl>
        <dl class="grid_4">
        ...
        <dl class="grid_4">
            <dt>E-mail :</dt>
            <dd><a href="marital@gmail.com">marital@gmail.com</a></dd>
        </dl>
      </address>
    </div>
   </div>
